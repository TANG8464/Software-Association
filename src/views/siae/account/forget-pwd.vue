    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="active" v-if="active===1">
                <el-form :model="forget" status-icon :rules="rules" ref="forget">
                    ...
                    <el-form-item prop="newPassword">
                        <el-input type="password" v-model="forget.newPassword" placeholder="重置密码"></el-input>
                    </el-form-item>
                    <el-form-item prop="confirmPassword">
                        <el-input type="password" v-model="forget.confirmPassword" placeholder="确认密码"></el-input>
                    </el-form-item>
            ...
            <div class="active" v-if="active===2">
                <div class="finish">
                    <h2 class="success">
                        <icon name="success" scale="40" width="40"></icon>重置成功
                    </h2>
        ...
        async next() {
            switch (this.active) {
                case 0:
                    ...
                    if (!email) this.emailError = '邮箱不能为空'
                    else if (!emailVerify(email)) this.emailError = '邮箱不请输入正确的邮箱能为空'
                    else {
                ...
                case 1:
                    ...
                    if (data.code === 200) {
                        this.active++
                    } else this.emailError = data.message
                    break
            }
        },
        async sendVerify() {
