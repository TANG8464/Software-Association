<template>
  <div class="login">
    <el-container :key="update" ref="loginBack" style="height: 100%">
      <div
        class="content-box"
        ref="content-box"
        :style="{ width, height, 'border-radius': borderRadius }"
      >
...
export default {
  ...
  computed: {
    ...
    width() {
      return this.lessThenMedium ? '100%' : '340px'
    },
    height() {
      return this.lessThenMedium ? '100%' : null
    },
    borderRadius() {
      return this.lessThenMedium ? 0 : '10px'
    },
  },
  watch: {
    $route(newVal) {
