...
<div>
    ...
    <div class="avatar-box" :style="{'height':`${height}px`}">
        <el-avatar ref="avatar" class="avatar" :src="head" :style="{'height':`${height}px`,'width':`${height}px`}" fit="fill" shape="square"></el-avatar>
        <div class="drag" ref="drag" :style="{'height':`${height}px`,'width':`${height}px`,'box-shadow': `0 0 0 ${height*0.3}px rgba(0, 0, 0, 0.4)`, 'clip': `rect(0px, ${height}px, ${height}px, 0px)`}"></div>
    </div>
</div>
</template>
