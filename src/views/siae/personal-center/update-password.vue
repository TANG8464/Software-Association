...
<div class="update-password">
    ...
    <el-form :model="safeForm" status-icon :rules="rules" :label-position="labelPosition" ref="safeForm" label-width="100px" class="demo-safeForm">
...
export default {
    ...
    data() {
        ...
        const validatorNew = (rule, value, callback) => {
            if (value === '') {
    ...
    methods: {
        ...
        async updatePassword() {
            const {
                data
            } = await this.$axios.put('member/password', this.safeForm)
