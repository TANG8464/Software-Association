  ...
  <div class="update-password">
    ...
    >
      ...
      <el-form-item style="text-align: right">
        <el-button type="primary" @click="submitForm('safeForm')" :disabled="!isSuccess"
          >确认修改</el-button
        >
...
import { updateMemberPassword } from '@/api/active-user'
export default {
  components: {
    VerifyCode,
  },
  ...
  methods: {
    ...
    async updateMemberPassword() {
      const res = await updateMemberPassword(this.safeForm)
      if (res.code !== 200) {
