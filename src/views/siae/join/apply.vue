...
<div class="apply">
    <div class="content" v-if="!isApplySuccess">
        ...
        <el-form class="applyFrom" ref="applyFrom" :model="applyFrom" label-position="top">
            ...
            <el-form-item prop="classID">
                <el-cascader placeholder="班级" v-model="applyFrom.cascadeClass" :options="cascadeClass" :props="{ expandTrigger: 'hover' }" @change="handleChangeCascadeClass"></el-cascader>
            </el-form-item>
            <el-form-item prop="stu_num">
                <el-input v-model="applyFrom.stu_num" placeholder="学号"></el-input>
            </el-form-item>
            <el-form-item>
                <el-upload ref="upload" class="upload-demo" :limit="1" action="#" drag :auto-upload="false" :on-change="importApply">
    ...
    <div class="finish" v-else>
        <h2 class="success">
            <icon name="success" scale="40" width="40"></icon>申请成功
        </h2>
        ...
        <!-- 
        <el-link type="primary" @click="$router.push('/join/my-apply')">查看已提交申请表</el-link> -->
    </div>
    <!-- 信息确认 -->
    ...
    <div class="pop-up-box" v-show="isSubmitted">
        <div class="bottom" ref="submitted">
            <div class="submitted-header">
                <span @click="isSubmitted=false" style="margin:10px;display:inline-block;color:#999999">
