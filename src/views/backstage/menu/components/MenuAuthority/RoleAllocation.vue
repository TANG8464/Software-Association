...
<div class="allocation role-allocation">
        ...
        <el-table :data="allRole">
            <el-table-column type="expand">
                <template slot-scope="props">
                    ...
                    <el-tree :data="props.row.menuNodeList" :default-expand-all="true" :props="menuProps" empty-text="尚未分配权限"></el-tree>
                </template>
            </el-table-column>
            ...
            <el-table-column width="110">
                <template slot-scope="scope">
                    <el-link :underline="false" type="primary" size="mini" @click="openDistribution(scope.$index, scope.row)">
    ...
    <el-dialog title="提示" v-if="isOpenDistri" :visible.sync="isOpenDistri" width="30%" @opened="$refs.power.setCheckedKeys(power.checked)">
        <el-form :model="power" :label-position="labelPosition">
            ...
            <el-form-item label="分配权限" :label-width="formLabelWidth">
                <el-tree ref="power" :data="menuTree" show-checkbox node-key="menuId" :highlight-current="true" :props="menuProps" :default-checked-keys="power.checked" :default-expanded-keys="power.expanded"></el-tree>
            </el-form-item>
        </el-form>
