...
<div class="manage">
    ...
    <!--动画效果-->
    <transition-group style="list-style:none" name="staggered-fade" tag="ul" v-bind:css="false" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:leave="leave" data-active="动画效果">
        <!--职位展示与管理-->
        <li class="positionMenu" data-active="职位展示与管理" v-for="(item,index) in allPosition" :key="index" :data-index="index">
    ...
    <!--添加职位弹出框-->
    <el-popover data-active="添加职位弹出框" placement="bottom" width="300" trigger="click" v-model="isOpenAdd" @close="position={}">
        <!--添加职位表单-->
        <div>
            <p>添加职位</p>
            ...
            <span slot="footer" class="dialog-footer" style="float:right;">
                ...
                <el-button type="primary" @click="addPosition()" @keypress.enter.native="addPosition()">确 定</el-button>
            </span>
        </div>
        <!--添加职位按钮-->
