...
<div class="allRes-resUpdate">
    <el-dialog title="修改信息" :visible.sync="isOpen" :width="size.isSmallSize?'100%':'40%'" @close="close">
        <el-form label-position="left" label-width="80px" :model="res">
            <el-form-item label="资源名称">
                <el-input v-model="res.resourceName"></el-input>
            </el-form-item>
            <el-form-item label="封面">
                <upload-cover v-if="isOpen" @setLogo="setLogo" :imageUrl="res.resourceLogo" :fileType="fileType" ref="cover"></upload-cover>
            </el-form-item>
            ...
            <el-form-item label="类别">
                <el-select v-model="res.resourceCategoryID" placeholder="请选择" style="width:100%">
                    <el-option v-for="item in resourceCategory" :key="item.id" :label="item.resourceCategoryName" :value="item.id" selected></el-option>
                </el-select>
            </el-form-item>
