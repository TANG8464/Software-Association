...
<div class="resUpload-allRes_queryCondition">
    ...
    <!--搜索框-->
    <all-res-search @setSearchContent="setSearchContent" ref="search"></all-res-search>
    <!--筛选条件框-->
    <el-popover placement="bottom" trigger="click" v-model="isOpenCondition">
        <ul style="list-style:none;">
            <li>
                <span class="condition_title">资源类别：</span>
                <el-select v-model="searchData.resourceCategoryId" placeholder="请选择" size="mini" style="width:110px;margin:0 5px;">
                    <el-option label="所有" :value="null"></el-option>
                    <el-option v-for="item in resourceCategory" :key="item.id" :label="item.resourceCategoryName" :value="item.id"></el-option>
                </el-select>
            </li>
            <li>
                <span class="condition_title">存储类型：</span>
                <el-select size="mini" v-model="searchData.type" placeholder="请选择" style="width:110px;margin:0 5px;">
            ...
            <li>
                ...
                <el-select size="mini" v-model="searchData.status" placeholder="请选择" style="width:110px;margin:0 5px;">
            ...
            <li>
                ...
                <el-select size="mini" v-model="searchData.limit" placeholder="请选择" style="width:110px;margin:0 5px;">
            ...
            <li>
                <el-button type="primary" size="mini" round style="width:100%" @click="queryCondition()">开始查询</el-button>
            </li>
        </ul>
