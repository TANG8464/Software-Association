      ...
      <el-form label-position="left" label-width="85px" :model="item">
          ...
          <template>
            <div style="display: flex; align-items: center; width: 100%">
              <div style="width: 100%">
                ...
                <el-input
                  v-model="item.configValue.securityKey"
                  :key="skStatus"
                  :type="item.skStatus"
                  readonly
                ></el-input>
                ...
                <el-button
                  ...
                  size="mini"
                  class="pwd-show"
                  @click="changeType(index, 'password')"
                  v-else
                  >隐藏</el-button
                >
              </div>
        ...
        <el-form-item label="操作">
          <template>
            ...
            <div v-else>
              <el-button size="mini" type="warning" plain @click="startUsing(index, item)"
                >启用</el-button
              >
              <el-button size="mini" type="danger" plain @click="handleDelete(index, item)"
                >删除</el-button
              >
            </div>
          </template>
