...
<div class="resUpload-upload_information">
    ...
    <upload-cover @setLogo="setLogo" :imageUrl="res.resourceLogo" :isOpenSelectable="true" :fileType="fileType"></upload-cover>
    ...
    <el-input type="textarea" placeholder="输入更多资源信息" v-model="res.description" maxlength="30" show-word-limit resize rows="4" />
...
export default {
    ...
    methods: {
        ...
        async setResSort() {
            ...
            let {
                data
            } = await this.$axios.get('resocategory/page', {
                params: {
                    limit: 1000
                }
            })
        ...
        async uploadResInfo() {
            ...
            const {
                data
            } = await this.$axios.post('resources/', this.res)
            if (data.code === 200) {
        ...
        async clearUpload() {
            ...
            const {
                data
            } = await this.$axios.delete('resources/cancel', {
                params: {
                    key: this.res.fileKey,
