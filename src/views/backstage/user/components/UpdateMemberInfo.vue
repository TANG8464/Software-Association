...
<div class="update-member-info">
    <el-dialog title="修改成员信息" :visible.sync="isOpen" width="45%" :fullscreen="size.isSmallSize">
        <member-info-form :personalInfo.sync="info" @submitForm="update" :col="2" :show="[
        'memberName','gender','cascadeClass','stu_num','phoneNum','nation','nativePlace','address','education','politicalOutlook','cardID','qq','email','description'
      ]"></member-info-form>
    </el-dialog>
</div>
</template>
