<template>
  <div class="phone-header" v-if="isShow">
...
<script>
import BackNavMenu from '@/components/backstage/BackNavMenu.vue'
import BackSidebar from '@/components/backstage/BackSidebar.vue'
export default {
  components: {
    BackNavMenu,
    BackSidebar,
